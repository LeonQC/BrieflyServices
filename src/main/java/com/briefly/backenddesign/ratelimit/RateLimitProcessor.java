package com.briefly.backenddesign.ratelimit;

import com.briefly.backenddesign.config.LocalCacheProperties;
    ...
    private void createRateLimiterCache() {
        ...
        rateLimiterCache =
                CacheBuilder.newBuilder()
                        .expireAfterAccess(localCacheProperties.keepAliveTime(), TimeUnit.MINUTES)
