package com.briefly.backenddesign.aspect;

import com.briefly.backenddesign.annotation.RateLimit;
import com.briefly.backenddesign.enums.LimitType;
import com.briefly.backenddesign.ratelimit.RateLimitProcessor;
import com.briefly.backenddesign.ratelimit.BucketTokenRateLimiter;
import com.briefly.backenddesign.utils.IpUtil;
import com.briefly.backenddesign.vo.RateLimiterInfo;
...
public class RateLimitInterceptor {
    ...
    @Around("execution(public * *(..)) && @annotation(com.briefly.backenddesign.annotation.RateLimit)")
